...
const Herosection = () => {
  ...
  const handleSearch = () => {
    ...
    router.push(`/jobs?keyword=${keyword}&city=${city}`);
  };
  ...
  return (
    <div className="h-170 bg-green-900 flex justify-center items-center p-20 pb-40 gap-[-10rem]">
      <div className="w-1/2 pb-1">
        ...
        <div className="p-4 bg-amber-50 rounded-full w-[36rem] flex items-center gap-4">
          ...
          <section>
            <button
              ...
              className="bg-green-900 px-7 py-2 rounded-full text-amber-50 text-lg"
            >
              Search
            </button>
          </section>
        ...
        <h1 className="text-lg pt-3 text-amber-50 font-bold">
          Popular Searches: Microservices Software Engineer
        </h1>
