...
import UXUI from "@/assets/images/uiux.webp";
import SproductMarketer from "@/assets/images/seniorproduct.webp";
    ...
    <div className=" h-150  bg-white pt-10">
      ...
      <div className="pt-15 px-30 grid grid-cols-3 gap-6">
        {jobCards.map((job, index) => (
          <section
            key={index}
            className="h-85 w-95 bg-gray-100 rounded-2xl p-5"
          >
            <section className="flex justify-between">
              ...
              <div className="flex gap-2">
                <RiVipCrown2Fill
                  className={`text-2xl ${
                    job.premium ? "text-yellow-500" : "text-gray-400"
                  }`}
                />
      ...
      <div className="text-center underline text-green-900 pt-10">
        <h1>View all Jobs</h1>
      </div>
    </div>
  );
